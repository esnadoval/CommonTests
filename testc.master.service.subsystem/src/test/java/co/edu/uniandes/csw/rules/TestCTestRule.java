...
public class TestCTestRule implements MethodRule {
    ...
    public TestCTestRule() {
      params = null;
      caseTestName = null;
    }
    public TestCTestRule(String caseTestName) {
        //Al instanciar esta regla, se generan los datos de prueba con podam. En este caso, se generan 5.
        PodamFactory factory = new PodamFactoryImpl();
        params = new Object[5];
        for (int i = 0; i < params.length; i++) {
            TestCDTO entity = factory.manufacturePojo(TestCDTO.class);
            entity.setId((long) 0);
